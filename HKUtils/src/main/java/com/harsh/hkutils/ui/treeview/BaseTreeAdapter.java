...
public abstract class BaseTreeAdapter<VH> implements TreeAdapter<VH> {
	...
	@Override
	public void setAlgorithm(@NonNull Algorithm algorithm) throws Exception {
		if (algorithm == null)
			throw new Exception("algorithm can't be null");
		mAlgorithm = algorithm;
	}

	@Override
	public void setRootNode(@NonNull TreeNode rootNode) throws Exception {
		if (rootNode == null)
			throw new Exception("rootNode can't be null");
